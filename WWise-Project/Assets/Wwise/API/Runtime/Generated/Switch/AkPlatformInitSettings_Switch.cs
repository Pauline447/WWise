...
public class AkPlatformInitSettings : global::System.IDisposable {
  ...
  public AkThreadProperties threadOpusDecoder { set { AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_threadOpusDecoder_set(swigCPtr, AkThreadProperties.getCPtr(value)); } 
    get {
      global::System.IntPtr cPtr = AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_threadOpusDecoder_get(swigCPtr);
      AkThreadProperties ret = (cPtr == global::System.IntPtr.Zero) ? null : new AkThreadProperties(cPtr, false);
      return ret;
    } 
  }
  ...
  public bool bAutoPanningRule { set { AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_bAutoPanningRule_set(swigCPtr, value); }  get { return AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_bAutoPanningRule_get(swigCPtr); } 
  }

  public bool bAcquireAudioDeviceNotification { set { AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_bAcquireAudioDeviceNotification_set(swigCPtr, value); }  get { return AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_bAcquireAudioDeviceNotification_get(swigCPtr); } 
  }
